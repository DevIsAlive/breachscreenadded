...
export default function Component() {
  ...
  const handleUIVisibility = (visible: boolean) => {
    setShowUIElements(visible)
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-400 to-blue-600 overflow-hidden">
      ...
      <AnimatePresence mode="wait">
        ...
        {currentPage === 5 && (
          <motion.div
            ...
            transition={pageTransition}
          >
            <HumanVerificationPage onNext={nextPage} username={username} onUIVisibilityChange={handleUIVisibility} />
          </motion.div>
        )}
        {currentPage === 6 && (
          <motion.div
      ...
      {/* Live Winners Ticker - Hidden during verification */}
      <AnimatePresence>{showUIElements && <LiveWinnersTicker />}</AnimatePresence>

      {/* Disclaimer Button - Hidden during verification */}
      <AnimatePresence>
        {showUIElements && <DisclaimerButton onClick={() => setIsDisclaimerModalOpen(true)} />}
      </AnimatePresence>
